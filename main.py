...
async def echo(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    If the message contains no text, or if the chat is not valid, no action is taken.

    Args:
        update (telegram.Update): The update object containing information about the message.
